...
class CityDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tvDetailIcon= findViewById<ImageView>(R.id.iv_detail_icon)
        ...
        val iconId = applicationContext.resources.getIdentifier(cities?.get(position)?.weather?.icon,"drawable",applicationContext.packageName)
        val drawableIcon= ResourcesCompat.getDrawable(applicationContext.resources,iconId,applicationContext.theme)
        tvDetailIcon.setImageDrawable(drawableIcon)
